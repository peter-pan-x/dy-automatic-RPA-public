...
class ElementSelectors:
    ...
    LIKE_BUTTON = [
        {
            ...
            "priority": 1,
            "description": "抖音当前版本点赞按钮（实测有效）"
        },
        {
            "by": By.XPATH,
            "value": "//android.widget.LinearLayout[contains(@content-desc, '点赞')]",
            "version": SelectorVersion.ALL,
            "priority": 2,
            "description": "通过content-desc匹配点赞"
        },
        {
            "by": By.XPATH,
        ...
        {
            "by": By.ID,
            "value": "com.ss.android.ugc.aweme:id/like_btn",
            "version": SelectorVersion.V27_PLUS,
            "priority": 5,
            "description": "抖音27.0+版本点赞按钮"
        }
    ]
    ...
    COMMENT_BUTTON = [
        {
            ...
            "version": SelectorVersion.ALL,
            "priority": 1,
            "description": "抖音当前版本评论按钮（实测有效）"
        },
        {
            "by": By.XPATH,
            "value": "//android.widget.LinearLayout[contains(@content-desc, '评论')]",
            "version": SelectorVersion.ALL,
            "priority": 2,
            "description": "通过content-desc匹配评论"
        },
        {
            "by": By.ID,
    ...
    COMMENT_INPUT = [
        ...
        {
            "by": By.XPATH,
            "value": "//android.widget.TextView[@text='留下你的精彩评论']",
            "version": SelectorVersion.ALL,
            "priority": 4,
            "description": "评论占位符"
        }
    ...
    FAVORITE_BUTTON = [
        {
            ...
            "version": SelectorVersion.ALL,
            "priority": 1,
            "description": "抖音当前版本收藏按钮（实测有效）"
        },
        {
            "by": By.XPATH,
            "value": "//android.widget.LinearLayout[contains(@content-desc, '收藏')]",
            "version": SelectorVersion.ALL,
            "priority": 2,
            "description": "通过content-desc匹配收藏"
        },
        {
            "by": By.ID,
    ...
    FOLLOW_BUTTON = [
        ...
        },
        {
            ...
            "version": SelectorVersion.ALL,
            "priority": 2,
            "description": "通过content-desc匹配关注按钮"
        },
        {
            "by": By.XPATH,
